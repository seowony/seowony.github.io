...
\item \textbf{The Origins of Blue Large-Amplitude Pulsators (BLAPs): Binary Interaction,
      ...
      (Core Research Program), Mar 2026 -- Feb 2029, 280M KRW 
\item \textbf{Understanding Galactic Disc Evolution with Stellar Activity and Kinematic
      Age}, National Research Foundation of Korea, Jun 2023 -- May 2026, 210M KRW 
\end{itemize}
...
\section*{Other}
\begin{itemize}
\item Mandatory Military Service as Technical Research Personnel, Republic of Korea
      (Sep 2010 -- Aug 2013)
\end{itemize}
...
\textbf{Prof.\ Christian Wolf} \\
Siding Spring Observatory Director \\
Research School of Astronomy \& Astrophysics \\
Australian National University \\
Email: \href{mailto:christian.wolf@anu.edu.au}{\tt christian.wolf@anu.edu.au}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\linewidth}
\textbf{Prof.\ Myungshin Im} \\
Professor, Department of Physics \& Astronomy \\
Seoul National University \\
Email: \href{mailto:m_im@snu.ac.kr}{\tt m\_im@snu.ac.kr}
\end{minipage}

\vspace{0.2in}

\begin{minipage}[t]{0.48\linewidth}
\textbf{Prof.\ Yong-Ik Byun} \\
Professor, Department of Astronomy \\
Yonsei University \\
Email: \href{mailto:ybyun@yonsei.ac.kr}{\tt ybyun@yonsei.ac.kr}
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\linewidth}
\textbf{Dr.\ Min-Su Shin} \\
Senior Researcher \\
Korea Astronomy and Space Science Institute \\
Email: \href{mailto:msshin@kasi.re.kr}{\tt msshin@kasi.re.kr}
\end{minipage}
